    ...
    */
    <main className="mx-auto flex min-h-screen max-w-2xl flex-col gap-10 p-6 lg:max-w-4xl">
      ...
      {/*
        ...
        ここは読ませる文章ではないので、説明文の prose 幅（672px）に合わせる理由がない。

        もとは本文と同じ672pxで止めていた。「2つ並ぶと1つあたりが420px近くになって
        間延びする」という理由だったが、**CTAの行だけが親より狭く、右側に余白が残って
        見えるほうが気になる**という判断で全幅にした（Issue #165）。
        幅を戻すなら、表とカードも一緒に狭めて画面全体で幅を揃えること。
      */}
